...
export function useProfiles() {
    const { profiles, loading, error, filters, total, setProfiles, setLoading, setError, setFilters, setTotal } = useProfilesStore();
    const fetchProfiles = async (filterOptions) => {
        try {
            setLoading(true);
            setError(null);
    ...
    const searchProfiles = async (query, filterOptions) => {
        try {
            setLoading(true);
            setError(null);
    ...
    const exportProfiles = async (filterOptions) => {
        try {
